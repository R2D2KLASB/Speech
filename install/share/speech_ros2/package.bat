...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\speech_ros2\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/speech_ros2/local_setup.bat"
